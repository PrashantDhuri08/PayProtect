...
class ScamDetectionService : AccessibilityService() {
    ...
    companion object {
        ...
        private const val ENGLISH_CONFIDENCE_THRESHOLD = 0.50

        // A slightly higher threshold for non-English text, as we won't have keyword validation.
        private const val NON_ENGLISH_CONFIDENCE_THRESHOLD = 0.70
    ...
    private val scamKeywords = listOf(
        ...
        "claim", "limited time", "transfer now", "send money", "bank", "password",
    ...
    override fun onAccessibilityEvent(event: AccessibilityEvent?) {
        try {
            if (event?.eventType == AccessibilityEvent.TYPE_NOTIFICATION_STATE_CHANGED) {
                ...
                // 🛑 Ignore notifications generated by this app itself
                if (pkgName == packageName) {
                    Log.d(TAG, "Ignoring self-generated notification from $pkgName.")
                    return
                }
                ...
                if (parcelable is Notification) {
                    ...
                    // ✅ Prefer message text over sender
                    val fullText = when {
                    ...
                    if (fullText.isNotBlank()) {
                        ...
                        // 1️⃣ Classify using the TFLite model
                        ...
                        // 3️⃣ Send alert if conditions met
                        if (sendAlert) {
...
//    }
    ...
    private fun sendNotification(appName: String, message: String) {
        ...
        val notification = NotificationCompat.Builder(this, channelId)
            .setSmallIcon(R.drawable.ic_scam_alert) // ✅ custom icon
            .setContentTitle("🚨 Scam Alert from $appName")
